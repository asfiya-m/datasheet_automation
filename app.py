...
st.title("📊 Master Equipment Sheet Generator")
...
if uploaded_file:
    if st.button("Generate Master DataSheet"):
        with st.spinner("Processing..."):
            output_path = generate_master_datasheet(uploaded_file)
        st.success("Done! ✅")
        with open(output_path, "rb") as f:
            st.download_button("📥 Download Master Sheet", f, file_name=output_path.name)
